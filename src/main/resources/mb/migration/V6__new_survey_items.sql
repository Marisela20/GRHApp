-- Solo inserta si no existe el ID=3
INSERT INTO discapacity_survey (id, name, description, created_at)
SELECT * FROM (
                  SELECT 3, 'Inclusión Laboral', 'Encuesta sobre inclusión de personas con discapacidad', NOW()
              ) AS tmp
WHERE NOT EXISTS (
    SELECT id FROM discapacity_survey WHERE id = 3
);
-- Insertar preguntas relacionadas con la encuesta id=3
INSERT INTO discapacity_question (id, survey_id, question_text, question_type, section, order_num)
VALUES
    (1001, 3, 'Seleccione el municipio de ubicación principal de su organización:', 'select', 1, 1),
    (1002, 3, '¿Cuál es el tamaño de la organización en términos de número de empleados?', 'select', 1, 2),
    (1003, 3, '¿Su organización cuenta con una política de inclusión laboral?', 'radio', 1, 3),
    (1004, 3, '¿La política de inclusión laboral está formalmente documentada?', 'radio', 1, 4),
    (1005, 3, '¿Cuántas personas con discapacidad trabajan actualmente en su organización?', 'select', 1, 5),
    (1006, 3, '¿Qué tipo de discapacidades presentan las personas vinculadas?', 'checkbox', 1, 6),
    (1007, 3, '¿Su organización realiza procesos de selección inclusivos?', 'radio', 1, 7),
    (1008, 3, '¿Existen ajustes razonables en el proceso de selección?', 'radio', 1, 8),
    (1009, 3, '¿La infraestructura de la organización es accesible?', 'radio', 1, 9),
    (1010, 3, '¿Existen rutas accesibles desde la entrada hasta los puestos de trabajo?', 'radio', 1, 10);
INSERT INTO discapacity_question (id, survey_id, question_text, question_type, section, order_num)
VALUES
    (1011, 3, '¿Los baños están adaptados para personas con discapacidad?', 'radio', 1, 11),
    (1012, 3, '¿Los ascensores (si existen) están adaptados para personas con discapacidad?', 'radio', 1, 12),
    (1013, 3, '¿Se han realizado ajustes en los puestos de trabajo para personas con discapacidad?', 'radio', 1, 13),
    (1014, 3, '¿Se brinda capacitación al personal sobre inclusión laboral?', 'radio', 1, 14),
    (1015, 3, '¿Con qué frecuencia se realiza dicha capacitación?', 'select', 1, 15),
    (1016, 3, '¿Existen canales de comunicación accesibles para personas con discapacidad?', 'radio', 1, 16),
    (1017, 3, '¿Qué medios de comunicación utiliza la organización para incluir a personas con discapacidad?', 'checkbox', 1, 17),
    (1018, 3, '¿Cuenta su organización con señalización accesible (visual, táctil, sonora)?', 'radio', 1, 18),
    (1019, 3, '¿Se realiza seguimiento a los empleados con discapacidad para evaluar su inclusión?', 'radio', 1, 19),
    (1020, 3, '¿Se han identificado barreras que dificulten la inclusión laboral?', 'radio', 1, 20);

INSERT INTO discapacity_question (id, survey_id, question_text, question_type, section, order_num)
VALUES
    (1021, 3, '¿Qué tipo de barreras ha identificado?', 'checkbox', 1, 21),
    (1022, 3, '¿Se han implementado medidas para eliminar estas barreras?', 'radio', 1, 22),
    (1023, 3, '¿Cuenta su organización con una política de inclusión laboral formalizada?', 'radio', 1, 23),
    (1024, 3, '¿Esa política se encuentra disponible para todos los empleados?', 'radio', 1, 24),
    (1025, 3, '¿Con qué frecuencia se evalúa la efectividad de dicha política?', 'select', 1, 25),
    (1026, 3, '¿La organización participa en redes o iniciativas de inclusión laboral?', 'radio', 1, 26),
    (1027, 3, '¿Con qué entidades externas se trabaja para la inclusión de personas con discapacidad?', 'checkbox', 1, 27),
    (1028, 3, '¿Se han contratado personas con discapacidad en el último año?', 'radio', 1, 28),
    (1029, 3, '¿Qué tipo de contratos se ofrecen a personas con discapacidad?', 'checkbox', 1, 29),
    (1030, 3, '¿Qué funciones desempeñan las personas con discapacidad contratadas?', 'text', 1, 30);

INSERT INTO discapacity_question (id, survey_id, question_text, question_type, section, order_num)
VALUES
    (1031, 3, '¿La organización ha realizado ajustes razonables en el entorno laboral?', 'radio', 1, 31),
    (1032, 3, '¿Qué tipo de ajustes razonables se han implementado?', 'checkbox', 1, 32),
    (1033, 3, '¿Los empleados reciben formación sobre inclusión y discapacidad?', 'radio', 1, 33),
    (1034, 3, '¿Con qué frecuencia se imparte dicha formación?', 'select', 1, 34),
    (1035, 3, '¿Existen canales de comunicación accesibles para todos los empleados?', 'radio', 1, 35),
    (1036, 3, '¿Cómo evalúa el clima laboral respecto a la inclusión?', 'select', 1, 36),
    (1037, 3, '¿Qué retos enfrenta su organización en la inclusión de personas con discapacidad?', 'text', 1, 37),
    (1038, 3, '¿Desea agregar algún comentario adicional sobre este tema?', 'text', 1, 38);
...
-- Pregunta 4: (texto libre) – No requiere opciones
...
INSERT INTO discapacity_answer_option (question_id, text, score) VALUES
                                                                    ...
                                                                    (1006, 'La alta dirección y/ gerencia', 2),
...
INSERT INTO discapacity_answer_option (question_id, text, score) VALUES
                                                                    ...
                                                                    (1019, 'Herramientas y equipos adaptado a la condición de la persona', 3),
...
INSERT INTO discapacity_answer_option (question_id, text, score) VALUES
                                                                    ...
                                                                    (1023, 'Recursos educativos para sensibilizar a las personas de la diferencia', 3),
...
INSERT INTO discapacity_answer_option (question_id, text, score) VALUES
                                                                    (1033, 'Guías para la gestión de actividades dentro de la empresa', 4),
...
INSERT INTO discapacity_answer_option (question_id, text, score) VALUES
                                                                    (1034, 'Formación en primeros auxilios psicológicos para la organización', 4),
